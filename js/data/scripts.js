...
window.ScriptLibrary = (function() {
    ...
    const SCRIPT_DATABASE = {
        ...
        warYears: [
            ...
            // PATRIOTIC MUSICALS
            { title: "Victory Through Song", genre: "musical", year: 1943, budget: 180000, quality: 70, description: "A group of Broadway performers stage an all-star musical revue to raise war bonds and boost troop morale.", censorRisk: 5, shootingDays: 22, themes: ["patriotism", "entertainment", "morale"], castRequirements: { male_lead: 2, female_lead: 2, dancers: 12 }, locationNeeds: ["theater", "backstage", "train_station"], historicalNotes: "All-star wartime musicals were a staple of studio patriotic output" },
            { title: "Yankee Doodle Girl", genre: "musical", year: 1942, budget: 200000, quality: 76, description: "A talented singer rises from vaudeville to become America's sweetheart, rallying the nation through song during wartime.", censorRisk: 5, shootingDays: 28, themes: ["patriotism", "showbusiness", "ambition"], castRequirements: { male_lead: 1, female_lead: 1, dancers: 10, supporting: 6 }, locationNeeds: ["theater", "vaudeville_stage", "broadway"], historicalNotes: "Patriotic musicals celebrating American spirit were guaranteed box office hits" },

            // FILM NOIR
            { title: "Dark Boulevard", genre: "mystery", year: 1944, budget: 115000, quality: 83, description: "A discharged soldier returns to find his girlfriend missing and descends into the city's shadowy underworld to find her.", censorRisk: 35, shootingDays: 20, themes: ["noir", "paranoia", "betrayal"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 6 }, locationNeeds: ["nightclub", "alley", "apartment"], historicalNotes: "Early film noir mixed wartime disillusionment with German Expressionist style" },
            { title: "The Black Market Ring", genre: "mystery", year: 1944, budget: 115000, quality: 77, description: "A detective uncovers a vast black market operation exploiting wartime rationing, leading to murder among the city's elite.", censorRisk: 30, shootingDays: 20, themes: ["crime", "rationing", "corruption"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 7 }, locationNeeds: ["warehouse", "nightclub", "police_station"], historicalNotes: "Black market crime was a potent subject during wartime rationing" },

            // HOME FRONT ADDITIONS
            { title: "The Riveter's Secret", genre: "thriller", year: 1943, budget: 140000, quality: 74, description: "A female factory worker discovers a sabotage ring inside an aircraft plant and must expose the spies before they strike.", censorRisk: 25, shootingDays: 22, themes: ["espionage", "homefront", "female_courage"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 8 }, locationNeeds: ["factory", "office", "warehouse"], governmentSupport: true, historicalNotes: "Wartime thrillers about enemy saboteurs reflected real fears of fifth columnists" },
            { title: "Behind Barbed Wire", genre: "drama", year: 1944, budget: 130000, quality: 76, description: "A Japanese-American family is torn apart when forced into an internment camp, testing their faith in the country they love.", censorRisk: 55, shootingDays: 24, themes: ["injustice", "loyalty", "identity"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 8 }, locationNeeds: ["internment_camp", "farm", "barracks"], historicalNotes: "Very few studios dared address Japanese internment during the war" },
            { title: "Home Before Dark", genre: "drama", year: 1945, budget: 135000, quality: 75, description: "A war bride struggles with loneliness, rationing, and raising children alone while praying for her husband's safe return.", censorRisk: 15, shootingDays: 22, themes: ["homefront", "loneliness", "resilience"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 5 }, locationNeeds: ["suburban_home", "factory", "church"], historicalNotes: "Late-war dramas began exploring the psychological toll on those left behind" },
            { title: "Somewhere in France", genre: "drama", year: 1943, budget: 155000, quality: 79, description: "A French schoolteacher leads a resistance cell against the Nazi occupation, risking everything to shelter downed Allied pilots.", censorRisk: 30, shootingDays: 26, themes: ["resistance", "occupation", "courage"], castRequirements: { male_lead: 2, female_lead: 1, supporting: 10 }, locationNeeds: ["french_village", "farmhouse", "checkpoint"], governmentSupport: true, historicalNotes: "Films glorifying European resistance movements were encouraged by OWI" },

            // WARTIME COMEDY ADDITIONS
            { title: "Private Snafu's Furlough", genre: "comedy", year: 1943, budget: 100000, quality: 63, description: "A hapless Army private gets a weekend pass and stumbles through a series of comic misadventures in the big city.", censorRisk: 15, shootingDays: 14, themes: ["military_life", "comedy", "romance"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 6 }, locationNeeds: ["army_base", "city_streets", "dance_hall"], historicalNotes: "Military comedies provided light relief during the darkest years of the war" },

            // WAR FILM ADDITIONS
            { title: "The Normandy Gambit", genre: "war", year: 1944, budget: 280000, quality: 84, description: "Allied forces plan and execute the daring D-Day invasion of Fortress Europe in this sprawling combat epic.", censorRisk: 20, shootingDays: 38, themes: ["invasion", "sacrifice", "strategy"], castRequirements: { male_lead: 4, female_lead: 0, supporting: 20 }, locationNeeds: ["beach", "command_center", "french_countryside"], specialRequirements: ["military_cooperation", "combat_scenes", "landing_craft"], governmentSupport: true, historicalNotes: "D-Day films appeared quickly as the government celebrated the liberation of Europe" }
        ],
        ...
        newWave: [
            ...
            // FRENCH NEW WAVE INFLUENCED
            { title: "Breathless in Paris", genre: "drama", year: 1961, budget: 250000, quality: 85, description: "A petty criminal and an American journalist drift through Paris in a freewheeling story that breaks every rule of classical filmmaking.", censorRisk: 40, shootingDays: 18, themes: ["rebellion", "existentialism", "youth"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 3 }, locationNeeds: ["paris_streets", "apartment", "cafe"], historicalNotes: "European art cinema influenced a generation of American independent filmmakers" },
            { title: "The Servant's Quarter", genre: "drama", year: 1963, budget: 300000, quality: 84, description: "A manservant gradually dominates and corrupts his weak-willed aristocratic employer in this taut British psychological drama.", censorRisk: 55, shootingDays: 20, themes: ["class", "manipulation", "decadence"], castRequirements: { male_lead: 2, female_lead: 1, supporting: 2 }, locationNeeds: ["townhouse", "pub", "restaurant"], historicalNotes: "British New Wave films explored class tension with unprecedented frankness" },

            // PSYCHOLOGICAL THRILLERS
            { title: "Cape of Dread", genre: "thriller", year: 1962, budget: 1500000, quality: 81, description: "A convicted rapist terrorizes the family of the lawyer who put him away, turning a houseboat vacation into a nightmare.", censorRisk: 55, shootingDays: 25, themes: ["revenge", "fear", "protection"], castRequirements: { male_lead: 2, female_lead: 1, supporting: 3 }, locationNeeds: ["houseboat", "southern_town", "swamp"], historicalNotes: "Pushing sexual menace boundaries accelerated the Hays Code's collapse" },
            { title: "Whatever Happened to Baby Judith?", genre: "thriller", year: 1962, budget: 1000000, quality: 82, description: "Two aging sisters -- one a former child star, the other a crippled ex-actress -- descend into madness in their decaying Hollywood mansion.", censorRisk: 40, shootingDays: 22, themes: ["jealousy", "madness", "aging"], castRequirements: { male_lead: 0, female_lead: 2, supporting: 4 }, locationNeeds: ["decaying_mansion", "beach_house", "bedroom"], historicalNotes: "Hagsploitation films gave aging female stars powerful comeback roles" },

            // SOCIAL DRAMAS
            { title: "Freedom March", genre: "drama", year: 1963, budget: 800000, quality: 83, description: "A Black minister leads his community in nonviolent protest against segregation in a small Southern town, facing brutal opposition.", censorRisk: 50, shootingDays: 22, themes: ["civil_rights", "nonviolence", "justice"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 10 }, locationNeeds: ["church", "courthouse", "southern_town"], historicalNotes: "Civil rights dramas emerged as Hollywood slowly engaged with the movement" },
            { title: "Lolita's Confession", genre: "drama", year: 1962, budget: 2000000, quality: 84, description: "A European professor becomes dangerously obsessed with his landlady's teenage daughter in suburban America.", censorRisk: 80, shootingDays: 24, themes: ["obsession", "forbidden_desire", "deception"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 3 }, locationNeeds: ["suburban_house", "motel", "college"], historicalNotes: "Controversial literary adaptations tested the limits of what studios would finance" },
            { title: "The Birdman of Rock Island", genre: "drama", year: 1962, budget: 2200000, quality: 78, description: "A violent prisoner serving life in solitary confinement finds redemption through the study and care of injured birds.", censorRisk: 25, shootingDays: 28, themes: ["redemption", "isolation", "nature"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 6 }, locationNeeds: ["prison_cell", "courtroom", "prison_yard"], historicalNotes: "Character-driven prison dramas showcased star performances over spectacle" },

            // COMEDY & HORROR ADDITIONS
            { title: "The Haunting of Hollow House", genre: "horror", year: 1963, budget: 1200000, quality: 80, description: "Four strangers spend a weekend in a notorious haunted mansion, where psychological terror proves more frightening than any ghost.", censorRisk: 30, shootingDays: 25, themes: ["fear", "psychology", "isolation"], castRequirements: { male_lead: 1, female_lead: 2, supporting: 3 }, locationNeeds: ["mansion", "library", "nursery"], historicalNotes: "Psychological horror relied on atmosphere over gore before the Code collapsed" },
            { title: "Pillow Conversations", genre: "comedy", year: 1961, budget: 1800000, quality: 72, description: "A career woman and a charming playboy share a party line and wage a battle of wits that inevitably turns to romance.", censorRisk: 20, shootingDays: 22, themes: ["battle_of_sexes", "romance", "deception"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 4 }, locationNeeds: ["apartment", "office", "restaurant"], historicalNotes: "Sex comedies with innuendo pushed boundaries while staying technically within the Code" },
            { title: "A Shot in the Parlor", genre: "comedy", year: 1964, budget: 2500000, quality: 74, description: "An impossibly clumsy French inspector investigates a murder at a millionaire's estate, bungling every clue yet stumbling onto the truth.", censorRisk: 15, shootingDays: 28, themes: ["farce", "incompetence", "mystery"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 8 }, locationNeeds: ["mansion", "nudist_camp", "police_station"], historicalNotes: "Slapstick comedy franchises proved audiences loved returning characters" }
        ],
        ...
        indieBoom: [
            ...
            // TARANTINO-STYLE CRIME
            { title: "True Crime Romance", genre: "crime", year: 1993, budget: 13000000, quality: 79, description: "A screenwriter and his girlfriend go on the run with a suitcase full of mob money after a drug deal turns deadly in Detroit.", censorRisk: 65, shootingDays: 25, themes: ["crime", "love", "pop_culture"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 8 }, locationNeeds: ["motel", "detroit_streets", "hollywood"], historicalNotes: "Indie crime films with pop culture dialogue defined the post-Tarantino wave" },
            { title: "Natural Born Outlaws", genre: "crime", year: 1994, budget: 15000000, quality: 77, description: "A young couple becomes America's most wanted serial killers, turned into media celebrities by a sensationalist press.", censorRisk: 85, shootingDays: 30, themes: ["media", "violence", "celebrity"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 6 }, locationNeeds: ["desert_highway", "diner", "prison"], historicalNotes: "Ultra-violent media satire sparked fierce debate about screen violence" },
            { title: "Minnesota Nice", genre: "crime", year: 1996, budget: 7000000, quality: 89, description: "A desperate car salesman hires two criminals to kidnap his wife for ransom, but a pregnant small-town police chief unravels the scheme.", censorRisk: 50, shootingDays: 28, themes: ["greed", "incompetence", "justice"], castRequirements: { male_lead: 2, female_lead: 1, supporting: 5 }, locationNeeds: ["snowy_town", "car_dealership", "lake"], historicalNotes: "Dark regional crime comedies proved indie auteurs could achieve mainstream success" },

            // SUNDANCE & KEVIN SMITH DIALOGUE FILMS
            { title: "Counter Culture", genre: "comedy", year: 1994, budget: 1200000, quality: 72, description: "Two slackers working at a convenience store spend the day arguing about pop culture, dealing with eccentric customers, and questioning their life choices.", censorRisk: 30, shootingDays: 12, themes: ["slacker", "friendship", "pop_culture"], castRequirements: { male_lead: 2, female_lead: 1, supporting: 6 }, locationNeeds: ["convenience_store", "video_rental", "parking_lot"], historicalNotes: "Ultra-low-budget dialogue-driven comedies launched the Sundance DIY movement" },
            { title: "The Piano Shores", genre: "drama", year: 1993, budget: 7000000, quality: 86, description: "A mute Scottish woman is sent to colonial New Zealand for an arranged marriage, communicating only through her beloved piano.", censorRisk: 55, shootingDays: 30, themes: ["female_autonomy", "desire", "colonialism"], castRequirements: { male_lead: 2, female_lead: 1, supporting: 3 }, locationNeeds: ["beach", "bush", "settler_cabin"], historicalNotes: "International art house films won Palme d'Or and crossed over to mainstream audiences" },

            // GEN-X COMEDIES
            { title: "Lounge Act", genre: "comedy", year: 1996, budget: 1000000, quality: 74, description: "Aspiring actors in Los Angeles spend their nights at cocktail lounges giving each other terrible advice about women and the entertainment industry.", censorRisk: 25, shootingDays: 18, themes: ["friendship", "ambition", "los_angeles"], castRequirements: { male_lead: 3, female_lead: 1, supporting: 4 }, locationNeeds: ["cocktail_lounge", "apartment", "hollywood_party"], historicalNotes: "Gen-X comedies captured the voice of a disaffected generation with razor-sharp wit" },
            { title: "Dazed and Bemused", genre: "comedy", year: 1993, budget: 6000000, quality: 78, description: "On the last day of school in 1976, Texas teenagers cruise, party, and ponder their futures in this aimless, affectionate hangout film.", censorRisk: 35, shootingDays: 22, themes: ["nostalgia", "youth", "freedom"], castRequirements: { male_lead: 3, female_lead: 2, supporting: 10 }, locationNeeds: ["high_school", "pool_hall", "field_party"], historicalNotes: "Ensemble hangout films launched multiple young actors to stardom" },

            // THRILLERS & ACTION
            { title: "Seven Deadly", genre: "thriller", year: 1995, budget: 30000000, quality: 84, description: "Two detectives -- one retiring, one idealistic -- hunt a serial killer staging elaborate murders based on the seven deadly sins.", censorRisk: 70, shootingDays: 32, themes: ["evil", "justice", "nihilism"], castRequirements: { male_lead: 2, female_lead: 1, supporting: 4 }, locationNeeds: ["rainy_city", "apartment", "desert"], historicalNotes: "Dark, nihilistic thrillers found huge audiences in the mid-1990s" },
            { title: "El Pistolero", genre: "action", year: 1992, budget: 1000000, quality: 70, description: "A wandering guitarist with a guitar case full of weapons seeks revenge against the drug lord who murdered his lover.", censorRisk: 45, shootingDays: 14, themes: ["revenge", "music", "violence"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 5 }, locationNeeds: ["mexican_border", "cantina", "desert_road"], historicalNotes: "Ultra-low-budget action launched careers and proved indie films could thrill" },
            { title: "Trainhopping", genre: "drama", year: 1996, budget: 3500000, quality: 82, description: "A group of Edinburgh heroin addicts chase the next fix, attempt to get clean, and try one last score to escape their bleak lives.", censorRisk: 75, shootingDays: 22, themes: ["addiction", "poverty", "escape"], castRequirements: { male_lead: 4, female_lead: 1, supporting: 3 }, locationNeeds: ["edinburgh", "flat", "pub"], historicalNotes: "British indie films about drugs and poverty found crossover success in America" }
        ],
        ...
        digitalDawn: [
            ...
            // MATRIX-STYLE ACTION & CGI SPECTACLES
            { title: "The Treadstone Protocol", genre: "action", year: 2002, budget: 60000000, quality: 81, description: "An amnesiac man fished from the sea discovers he has lethal combat skills and must uncover his identity while evading assassins.", censorRisk: 30, shootingDays: 45, themes: ["identity", "conspiracy", "survival"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 5 }, locationNeeds: ["paris", "zurich", "safe_house"], historicalNotes: "Gritty, realistic spy thrillers challenged the fantasy of the Bond franchise" },
            { title: "Dark City Nights", genre: "sci_fi", year: 1998, budget: 27000000, quality: 79, description: "A man wakes with no memory in a city where the sun never rises and discovers alien beings reshape reality each midnight.", censorRisk: 20, shootingDays: 30, themes: ["identity", "reality", "control"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 5 }, locationNeeds: ["dystopian_city", "underground", "rooftop"], historicalNotes: "Neo-noir sci-fi thrillers explored reality and identity before The Matrix" },

            // LORD OF THE RINGS SCALE EPICS & ADVENTURE
            { title: "Pirates of the Crimson Seas", genre: "adventure", year: 2003, budget: 140000000, quality: 80, description: "A roguish pirate captain teams with a blacksmith to rescue a governor's daughter from a crew of cursed undead pirates.", censorRisk: 15, shootingDays: 60, themes: ["adventure", "curse", "freedom"], castRequirements: { male_lead: 2, female_lead: 1, supporting: 8 }, locationNeeds: ["pirate_ship", "caribbean_island", "treasure_cave"], historicalNotes: "Theme park ride adaptations proved any IP could launch a blockbuster franchise" },

            // ROMCOMS
            { title: "My Big Fat Greek Celebration", genre: "romance", year: 2002, budget: 5000000, quality: 72, description: "A thirty-something Greek-American woman falls for a non-Greek man and must navigate her loud, overbearing family's expectations.", censorRisk: 10, shootingDays: 22, themes: ["family", "culture", "romance"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 10 }, locationNeeds: ["family_home", "restaurant", "church"], historicalNotes: "Low-budget romantic comedies could still become massive sleeper hits" },
            { title: "The Seahaven Show", genre: "drama", year: 1998, budget: 60000000, quality: 86, description: "A man discovers his entire life has been a fabricated reality TV show broadcast to the world since his birth.", censorRisk: 10, shootingDays: 35, themes: ["reality", "freedom", "media"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 6 }, locationNeeds: ["perfect_suburb", "tv_studio", "ocean"], historicalNotes: "Prescient media satires anticipated the reality TV explosion" },

            // HORROR REMAKES & THRILLERS
            { title: "The Cursed Videotape", genre: "horror", year: 2002, budget: 48000000, quality: 73, description: "A journalist investigates an urban legend about a videotape that kills anyone who watches it exactly seven days later.", censorRisk: 35, shootingDays: 30, themes: ["curse", "investigation", "technology"], castRequirements: { male_lead: 0, female_lead: 1, supporting: 4 }, locationNeeds: ["cabin", "apartment", "well"], historicalNotes: "Hollywood remakes of Japanese horror became a hugely profitable trend" },
            { title: "Remember Nothing", genre: "thriller", year: 2000, budget: 9000000, quality: 87, description: "A man with short-term memory loss hunts for his wife's killer using tattoos, photos, and notes to reconstruct his fractured memory.", censorRisk: 35, shootingDays: 22, themes: ["memory", "revenge", "identity"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 4 }, locationNeeds: ["motel", "tattoo_parlor", "warehouse"], historicalNotes: "Non-linear indie thrillers found mainstream audiences in the DVD era" },
            { title: "Crash of Strangers", genre: "drama", year: 2004, budget: 6500000, quality: 76, description: "Interconnected lives in Los Angeles collide over 36 hours, exposing racial prejudice, fear, and unexpected compassion.", censorRisk: 40, shootingDays: 25, themes: ["racism", "connection", "prejudice"], castRequirements: { male_lead: 3, female_lead: 2, supporting: 8 }, locationNeeds: ["los_angeles", "intersection", "hospital"], historicalNotes: "Multi-strand ensemble dramas became a prestigious subgenre in the DVD era" },

            // ANIMATED & WAR
            { title: "Monster Factory", genre: "animated", year: 2001, budget: 115000000, quality: 84, description: "Monsters who power their city by scaring children discover that laughter generates ten times more energy than screams.", censorRisk: 5, shootingDays: 0, themes: ["friendship", "energy", "laughter"], castRequirements: { voice_cast: 6 }, locationNeeds: ["monster_city", "factory_floor", "child_bedroom"], historicalNotes: "Pixar's consistently brilliant output made CGI animation the dominant family format" },
            { title: "Mogadishu Descent", genre: "war", year: 2001, budget: 92000000, quality: 80, description: "A routine mission in war-torn Somalia spirals into a desperate 18-hour battle for survival when two helicopters are shot down.", censorRisk: 50, shootingDays: 45, themes: ["survival", "brotherhood", "chaos"], castRequirements: { male_lead: 4, female_lead: 0, supporting: 12 }, locationNeeds: ["mogadishu", "helicopter", "urban_combat"], historicalNotes: "Hyper-realistic modern war films used handheld cameras and digital effects" }
        ],
        ...
        convergence: [
            ...
            { title: "The Incredible Bulk", genre: "superhero", year: 2008, budget: 150000000, quality: 68, description: "A scientist exposed to gamma radiation transforms into an unstoppable green giant and battles a military general who wants the same power.", censorRisk: 15, shootingDays: 45, themes: ["rage", "control", "identity"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 4 }, locationNeeds: ["lab", "university", "harlem_streets"], historicalNotes: "Not every superhero launch connected with audiences equally" },
            { title: "The Hero Initiative", genre: "superhero", year: 2010, budget: 220000000, quality: 79, description: "Earth's mightiest heroes must unite to stop an alien invasion, but first they must overcome their massive egos.", censorRisk: 15, shootingDays: 55, themes: ["teamwork", "heroism", "sacrifice"], castRequirements: { male_lead: 4, female_lead: 1, supporting: 6 }, locationNeeds: ["helicarrier", "new_york", "secret_base"], historicalNotes: "The shared cinematic universe model revolutionized franchise filmmaking forever" },

            // FOUND FOOTAGE HORROR
            { title: "Manhattan Monster", genre: "horror", year: 2008, budget: 25000000, quality: 72, description: "Partygoers in Manhattan document a massive monster attack on their handheld camera as the city crumbles around them.", censorRisk: 25, shootingDays: 18, themes: ["survival", "spectacle", "found_footage"], castRequirements: { male_lead: 2, female_lead: 2, supporting: 3 }, locationNeeds: ["manhattan", "brooklyn_bridge", "subway_tunnel"], historicalNotes: "Found footage techniques merged with blockbuster spectacle and viral marketing" },

            // PIXAR-STYLE ANIMATION
            { title: "Le Petit Chef", genre: "animated", year: 2007, budget: 150000000, quality: 88, description: "A rat with an extraordinary palate secretly controls a hapless garbage boy to cook in the finest restaurant in Paris.", censorRisk: 5, shootingDays: 0, themes: ["ambition", "creativity", "acceptance"], castRequirements: { voice_cast: 7 }, locationNeeds: ["paris_restaurant", "sewer", "kitchen"], historicalNotes: "Animated films proved any premise could work if the storytelling was exceptional" },

            // OSCAR-BAIT DRAMAS
            { title: "The King's Voice", genre: "drama", year: 2010, budget: 15000000, quality: 85, description: "The stammering Duke of York works with an unconventional speech therapist to find his voice as he unexpectedly becomes King.", censorRisk: 10, shootingDays: 30, themes: ["courage", "friendship", "duty"], castRequirements: { male_lead: 2, female_lead: 1, supporting: 4 }, locationNeeds: ["buckingham_palace", "therapy_room", "bbc_studio"], historicalNotes: "Modest-budget British period dramas could still win Best Picture" },
            { title: "Oil Baron's Blood", genre: "drama", year: 2007, budget: 25000000, quality: 91, description: "A ruthless oil prospector builds an empire in early 1900s California, destroying everyone around him including his adopted son.", censorRisk: 35, shootingDays: 50, themes: ["greed", "religion", "ambition"], castRequirements: { male_lead: 1, female_lead: 0, supporting: 5 }, locationNeeds: ["oil_derrick", "california_desert", "church"], historicalNotes: "Epic character studies with towering performances commanded awards attention" },
            { title: "Bomb Squad Baghdad", genre: "war", year: 2008, budget: 15000000, quality: 87, description: "An adrenaline-addicted bomb disposal expert takes increasingly reckless risks during his final rotation in Iraq.", censorRisk: 40, shootingDays: 30, themes: ["addiction", "war", "masculinity"], castRequirements: { male_lead: 2, female_lead: 0, supporting: 5 }, locationNeeds: ["baghdad_streets", "military_base", "desert"], historicalNotes: "Low-budget Iraq War films struggled commercially but dominated awards season" },

            // GLOBAL BLOCKBUSTERS & THRILLERS
            { title: "Metal Titans", genre: "action", year: 2007, budget: 150000000, quality: 65, description: "Giant alien robots wage war on Earth, with humanity caught in the crossfire between warring mechanical factions.", censorRisk: 15, shootingDays: 55, themes: ["destruction", "heroism", "aliens"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 6 }, locationNeeds: ["military_base", "city_streets", "hoover_dam"], historicalNotes: "Toy-based blockbusters proved global audiences craved spectacle above all" },
            { title: "The Zodiac Files", genre: "thriller", year: 2007, budget: 65000000, quality: 83, description: "A cartoonist becomes obsessed with identifying the Zodiac killer, pursuing the case for decades as it consumes his life.", censorRisk: 35, shootingDays: 40, themes: ["obsession", "truth", "paranoia"], castRequirements: { male_lead: 3, female_lead: 0, supporting: 5 }, locationNeeds: ["san_francisco", "newspaper_office", "basement"], historicalNotes: "True crime procedurals found new life as prestige films" },
            { title: "Juniper's Dilemma", genre: "comedy", year: 2007, budget: 10000000, quality: 80, description: "A sharp-tongued pregnant teenager navigates adoption, first love, and growing up in this offbeat indie comedy.", censorRisk: 20, shootingDays: 22, themes: ["pregnancy", "growing_up", "family"], castRequirements: { male_lead: 1, female_lead: 1, supporting: 5 }, locationNeeds: ["suburban_house", "high_school", "hospital"], historicalNotes: "Quirky indie comedies with distinctive voices found mainstream crossover success" }
        ]
    };
